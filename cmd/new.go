...
func New() *cli.Command {
	return &cli.Command{
		...
		Flags: []cli.Flag{
			...
			&cli.StringFlag{
				Name:  "fe-git-url",
				Usage: "Use git repository to initialize the frontend project (default: https://github.com/supermicah/go-framework-frontend.git)",
				Value: "https://github.com/supermicah/go-framework-frontend.git",
			},
			&cli.StringFlag{
				Name:  "fe-git-branch",
